//La mera verdad pense que se entregaba a las 11:59 :,(
...
int main() {
    ...
    string nombreProducto[100] = {"Martillo", "Desarmador de Cruz", "Desarmador de Línea", "Cerrucho", "Martillo de Bola"};
    int cantidadProducto[100] = {5, 7, 7, 3, 5};
    float precioProducto[100] = {150.00, 100.00, 100.00, 200.00, 150.00};
...
/*======================================================================================
  1.6 - OPCIÓN 5: SALIR DEL PROGRAMA
======================================================================================*/
        
        else if (opc == 5) {
            
            /*------- 6.0 - Mensaje de salida y cambio de variable salir a true -------*/
            cout << "Saliendo..." << endl;
...
/*======================================================================================
  OPCIÓN INVÁLIDA - MANEJO DE ERRORES
======================================================================================*/
        
        else {
            /*------- 7.0 - Mensaje de alerta y vuelta al menú gracias al ciclo while -------*/
